...
install : common.o search_main.o callback.o ${PROG_NAME}.o database.o
	echo "Creating config directory"
	${MKDIR} ~/.${PROG_NAME}
	${CC} -Wall -o ${PROG_NAME} common.o search_main.o baptism_callback.o ${PROG_NAME}.o database.o -l sqlite3 ${FLAGS}
